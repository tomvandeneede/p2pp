...
**IMPORTANT**
> Prior to using the script it is imperative that you setup the printer/Slicer PE according to the [specifications set by Mosaic](https://support.mosaicmfg.com/hc/en-us/articles/115001965433-Slic3r-and-Chroma-Setup) (this includes full calibration using canvas or Chroma). Then, follow the guide(s) below and create a new Printer profile, as there are some settings that contradict the Mosaic Guide for slicing with Chroma. In addition, it's important that your printer's extruder is calibrated and working correctly.


## WINDOWS INSTALLATION

> If you have installed Python 2 or Python 3 previously and did not add Python to your system path, this this section is important for you. When updating p2pp to a new version, any customization you have done in the .bat file is overwritten. Make sure to copy the .bat file elsewhere on your system before updating this software on your system. Copy the file over the newly unzipped file to complete the installation.

If you have not yet installed Python on your system, please download the latest release from [https://www.python.org/downloads/](https://www.python.org/downloads/) Pay attention to the installation windows, and be sure to select the checkbox to add Python to your system PATH.
...
3. If you did not ocnfigure Python to be added to your system PATH, you will need to alter the following line in the .bat file:
- Change "c:\python27\python.exe" to the path and filename of your Python installation. For example:
...
> When updating p2pp to a new version, any customization you have done in the .sh file is overwritten. Make sure to copy the .sh file elsewhere on your system before updating this software on your system. Copy the file over the newly unzipped file to complete the installation.
