...
python ./p2pp.py -i tests/TestFirmware.gcode -d tests/output/TestFirmware.mcf.gcode
python ./p2pp.py -i tests/TestSoftware.gcode -d tests/output/TestSoftware.mcf.gcode
